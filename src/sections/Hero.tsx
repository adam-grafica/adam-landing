      ...
      <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pt-24 lg:pt-32">
        <div className="max-w-3xl">
          ...
          <div className="hero-ctas flex flex-col sm:flex-row gap-4 mb-12">
            <a href="#contact" data-open-modal="contact" className="btn-primary group" aria-label="Agendar diagnóstico gratuito desde la sección de inicio" onClick={() => trackCTAClick('Quiero mi Imperio Digital', 'Hero')}>
